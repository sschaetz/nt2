...
namespace boost { namespace simd
{
  namespace tag
  {
    ...
    **/
    ...
    BOOST_SIMD_FUNCTION_DECLARE(stream_)
  }
  ...
  **/
  ...
  {
    BOOST_DISPATCH_MAKE_CALL(tag::stream_, stream_, 3, (val, ptr, offset));
  }
  ...
  {
    BOOST_DISPATCH_MAKE_CALL(tag::stream_, stream_, 2, (val, ptr));
  }
} }
