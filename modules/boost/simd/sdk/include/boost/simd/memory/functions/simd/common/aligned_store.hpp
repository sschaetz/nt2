...
namespace boost { namespace simd { namespace ext
{
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF( aligned_store_
                                      , tag::cpu_
                                      , (A0)(A1)(A2)(X)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF( aligned_store_, tag::cpu_
                                      , (A0)(A1)(A2)(X)(Y)
                                      , (mpl::and_
                                          < mpl::equal_to
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( aligned_store_, tag::cpu_
                                   , (A0)(A1)(A2)(X)
