...
namespace boost { namespace simd { namespace ext
{
  ...
  //==============================================================================
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::schedule_, tag::formal_
                                   , (A0)(D)(F)
  ...
  // Elementwise
  //==============================================================================
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::schedule_assign_, tag::formal_
                                   , (A0)(A1)(D)(T1)(N1)(F)
                                   , (unspecified_<A0>)
