...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF_GEN ( boost::simd::tag::bitwise_andnot_, boost::simd::tag::sse2_, (A0)(A1)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN(boost::simd::tag::bitwise_andnot_, boost::simd::tag::sse2_, (A0),
