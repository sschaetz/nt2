...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF_GEN( boost::simd::tag::bitwise_ornot_, tag::cpu_, (A0)(A1),
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::bitwise_ornot_, tag::cpu_ , (A0)(A1)
                            , (scalar_< bool_<A0> >)
                              (scalar_< bool_<A1> >)
                            )
  {
