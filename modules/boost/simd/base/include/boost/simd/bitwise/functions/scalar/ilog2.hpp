...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::ilog2_, tag::cpu_, (A0)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::ilog2_, tag::cpu_
                            , (A0)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF_GEN( boost::simd::tag::ilog2_, tag::cpu_
                            , (A0)
