...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( ilog2_, tag::cpu_, (A0)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( ilog2_, tag::cpu_
                            , (A0)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF( ilog2_, tag::cpu_
                            , (A0)
