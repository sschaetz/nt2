...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::is_not_nan_, tag::cpu_
                            , (A0)(X)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::is_not_nan_, tag::cpu_, (A0)(X)
