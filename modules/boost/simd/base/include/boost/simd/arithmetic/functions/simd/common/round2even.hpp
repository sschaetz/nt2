...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::round2even_, tag::cpu_, (A0)(X)
                            , ((simd_<integer_<A0>,X>))
                            )
  {
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::round2even_, boost::simd::tag::simd_, (A0)(X)
