...
namespace boost { namespace simd { namespace ext
{
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::min_, boost::simd::tag::sse2_, (A0)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::min_, boost::simd::tag::sse2_
                            , (A0)
