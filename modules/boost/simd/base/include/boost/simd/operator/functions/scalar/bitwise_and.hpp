...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF_GEN ( boost::simd::tag::bitwise_and_ , tag::cpu_, (A0)(A1)
...
//   BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::bitwise_and_, tag::cpu_, (A0)(A1)
//                             , (scalar_< logical_<A0> >)
//                               (scalar_< logical_<A1> >)
//                             )
//   {
