...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::multiplies_, tag::cpu_, (A0)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::multiplies_, tag::cpu_, (A0)(A1)
