...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF_GEN(boost::simd::tag::bitwise_xor_, tag::cpu_,
                                (A0)(A1)(X),
  ...
  // mixed scalar/simd
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_GEN( boost::simd::tag::bitwise_xor_, tag::cpu_,
                                    (A0)(A1)(X),
