...
{
  /// INTERNAL ONLY
  NT2_FUNCTOR_IMPLEMENTATION_GEN( nt2::tag::diag_of_, tag::cpu_, (A0), ((ast_<A0, nt2::container::domain>)) )
  {
  ...
  /// INTERNAL ONLY
  NT2_FUNCTOR_IMPLEMENTATION_GEN( nt2::tag::offset_diag_of_, tag::cpu_
                            , (A0)(A1)
