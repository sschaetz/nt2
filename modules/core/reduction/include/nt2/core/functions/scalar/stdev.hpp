...
namespace nt2 { namespace ext
{
  ...
  NT2_FUNCTOR_IMPLEMENTATION_GEN( nt2::tag::stdev_, tag::cpu_, (A0)
  ...
  NT2_FUNCTOR_IMPLEMENTATION_GEN( nt2::tag::stdev_, tag::cpu_, (A0)(A1)
                            , (scalar_< unspecified_<A0> >)
                              (scalar_< integer_<A1> >)
                            )
  {
  ...
  NT2_FUNCTOR_IMPLEMENTATION_GEN( nt2::tag::stdev_, tag::cpu_, (A0)(A1)(A2)
                              , (scalar_< unspecified_<A0> >)
