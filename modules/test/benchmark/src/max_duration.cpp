...
namespace nt2
{
  ...
  max_duration::max_duration(double d) : duration_(d)
  {

  }

  NT2_TEST_BENCHMARK_DECL max_duration::~max_duration() {}


  NT2_TEST_BENCHMARK_DECL
  void max_duration::run(experiment* e)
  {
    ...
    do
    {
      ...
      times_( to_microseconds(elapsed_time - details::quantums_overhead) );
      cycles_(burned_cycles - details::cycles_overhead);
